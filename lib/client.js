...
`.trim()
    ...
    //========================================================================================================================================
    Void.getName = (jid, withoutContact = false, isCheckNew = false) => {
      ...
      if (isCheckNew) {
        return {
          name: v.name || "Unkown",
          verifiedName: v.verifiedName || "Unkown",
          subject: v.subject || "Unkown",
          user: Void.user || {},
          decoded: store.contacts[id] || store.contacts[id] || {},
        };
      }
      return (
      ...
      if (connection === "open") {
        ...
        function _0x1228() {
          const _0x44faa2 = [
            ...
            "25524zIwSmd",
            "false",
            "_Secktor\x20has\x20been\x20integrated._\x0a_Total\x20Plugins\x20:\x20",
            "\x5c+\x5c+\x20*(?:[a-zA-Z_$][0-9a-zA-Z_$]*)",
            "430htWnSK",
            "Disable\x20PM:\x20✅",
            "@s.whatsapp.net",
  ...
  Void.getContact = (jid) => {
    ...
    return {
      ...
      phone: PhoneNumber("+" + jid.replace("@s.whatsapp.net", "")).getNumber(
        "international"
      ),
    };
  };
